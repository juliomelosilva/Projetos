...
def calcular_perdas_ganhos():
    for i in range(31):
        ...
        try:
            ...
            perdas_ganhos = (medicao_final - medicao_calculada) / medicao_calculada * 100
            perdas_ganhos_entries[i].set(f'{perdas_ganhos:.2f} %')
        except ValueError:
            perdas_ganhos_entries[i].set("0,00 %")
...
tk.Label(frame, text="Perdas/Ganhos (%)").grid(row=0, column=9)
...
# Texto "By Júlio Cesar" no canto inferior direito
